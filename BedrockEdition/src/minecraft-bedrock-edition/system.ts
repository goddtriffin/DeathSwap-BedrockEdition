...
import { Block, Component, Entity, EventData, Query, TickingArea } from "./objects";
...
export interface System {
     ...
     * @return {Array<Array<Array<Block>>> | null}
     */
    getBlocks(tickingArea: TickingArea, minX: number, minY: number, minZ: number, maxX: number, maxY: number, maxZ: number): Array<Array<Array<Block>>> | null;
     ...
     */
    listenForEvent(eventIdentifier: string, callback: {(eventData: EventData): void;}): boolean;
